        ...
        <section id="neighborhood" className="py-20 bg-gray-50">
            <div className="container mx-auto px-4">
                <div className="text-center mb-16">
                    <h2 className="text-sm font-bold text-yellow-600 uppercase tracking-wider mb-2">Localização</h2>
                ...
                <div className="grid md:grid-cols-2 gap-12 items-center mb-16">
                    <div>
                        ...
                        <p className="text-gray-700 mb-6">
                            Viver na Mooca é estar no coração da cidade, cercado por tudo o que faz do bairro um dos
                            mais desejados de
                            São Paulo. Com lazer e facilidades próximos como o Mooca Plaza Shopping, os hospitais Villa
                            Lobos (Rede
                            D'Or) e Sancta Maggiore, do Parque Sabesp Mooca, tradicional Clube Atlético Juventus, e
                            gastronomia com
                            tradição e uma grande diversidade.
                        </p>
                        <p className="text-gray-700 mb-8">
                            A Mooca é um dos bairros mais ricos no quesito culinário com diversos restaurantes. Uma
                            localização
                            completa, que une mobilidade, conveniência, tradição e o estilo único.
                        </p>

                        <div className="flex flex-col sm:flex-row gap-4">
                            <a href="https://maps.app.goo.gl/yi6CchBJHKJ1orKz9" target="_blank" rel="noopener">
                                <Button className="bg-red-600 hover:bg-red-700 text-white">
                                    Ver no Google Maps
                                </Button>
                            </a>
                            <a href="https://www.google.com/maps/dir/?api=1&destination=Rua+Padre+Raposo,+298+-+Mooca,+São+Paulo+-+SP" target="_blank" rel="noopener">
                    ...
                    <div className="relative h-[400px] rounded-lg overflow-hidden shadow-xl">
                        <iframe
                            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d1224.4623500383113!2d-46.59846664893384!3d-23.558957921215892!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x94ce594bfc4fbd13%3A0x46ccd68c79b4a6ff!2sR.%20Padre%20Raposo%2C%20298%20-%20Mooca%2C%20S%C3%A3o%20Paulo%20-%20SP%2C%2003118-000!5e0!3m2!1spt-BR!2sbr!4v1750517111475!5m2!1spt-BR!2sbr"
                            width="100%"
                            height="100%"
                            style={{border: 0}}
                            ...
                            <div className="grid md:grid-cols-3 gap-6">
                                ...
                                <div className="md:col-span-2 flex flex-col justify-center">
                                    ...
                                    <p className="text-gray-700 mb-4">
                                        A Mooca é um dos bairros mais tradicionais de São Paulo, com forte influência
                                        italiana e uma rica
                                        história cultural. Ao mesmo tempo, o bairro passou por uma revitalização nos
                                        últimos anos, atraindo
                                        novos empreendimentos e moradores.
                                    </p>
                                    <p className="text-gray-700">
                                        O Clube Atlético Juventus, carinhosamente chamado de "Moleque Travesso", é um
                                        dos símbolos do
                                        bairro, assim como as tradicionais cantinas italianas e padarias que preservam
                        ...
                        <TabsContent value="shopping">
                            <div className="grid md:grid-cols-3 gap-6">
                                ...
                                <div className="md:col-span-2 flex flex-col justify-center">
                                    ...
                                    <p className="text-gray-700 mb-4">
                                        O Mooca Plaza Shopping é um dos principais centros de compras da região, com
                                        mais de 200 lojas,
                                        praça de alimentação, cinema e diversas opções de lazer para toda a família.
                                    </p>
                                    <p className="text-gray-700">
                                        Além do shopping, o bairro conta com comércio de rua tradicional, com lojas de
                                        diversos segmentos,
                                        desde moda até utilidades domésticas, atendendo a todas as necessidades dos
                                        moradores.
                                    </p>
                                </div>
                            </div>
                        ...
                        <TabsContent value="gastronomy">
                            <div className="grid md:grid-cols-3 gap-6">
                                ...
                                <div className="md:col-span-2 flex flex-col justify-center">
                                    ...
                                    <p className="text-gray-700 mb-4">
                                        A Mooca é conhecida por sua excelente gastronomia, especialmente a italiana.
                                        Cantinas tradicionais,
                                        pizzarias premiadas e restaurantes contemporâneos fazem parte da paisagem do
                                        bairro.
                                    </p>
                                    <p className="text-gray-700">
                                        Destaque para estabelecimentos como Cantina Di Napoli, Pizzaria Speranza e
                                        diversos outros
                                        restaurantes que preservam receitas tradicionais passadas de geração em geração,
                                        oferecendo uma
                    ...
                    {neighborhoodFeatures.map((feature, index) => (
                        <div key={index} className="bg-white p-6 rounded-lg shadow-md">
                            <div className="flex items-center mb-4">
                                <div
                                    className="mr-4 flex h-12 w-12 items-center justify-center rounded-full bg-red-100">
                                    {feature.icon}
                                </div>
